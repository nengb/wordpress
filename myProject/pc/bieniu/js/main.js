...
$(function(){
	var Img=$(".bannerTop>span");
	var ImgLineLeft=$('.bannerTopLeft');
	var ImgLineRight=$('.bannerTopRight');
			Img.addClass('animated fadeInUp');
			ImgLineLeft.addClass('animated fadeInLeft');
			ImgLineRight.addClass('animated fadeInRight');
	...
	$(document).scroll(function(){
		if($(document).scrollTop() > 0){
		 ...
		 if($(document).scrollTop() > 150){
			...
			ImgLineLeft.removeClass('fadeInLeft');
			ImgLineRight.removeClass('fadeInRight');
